          ...
          <div className="card card border-dark shadow mb-2 bg-white rounded img-thumbnail">
            ...
            <div className="card-body">
             ...
             <small className="text-muted">
                <a href={"https://www.yoututor2020.herokuapp.com"} value="yoututorheroku" target={"_blank"} >Find A Tutor Web</a>
                <a href={"https://www.github.com/OlgaSadova/FinalProject"} value="yoututorgithubfront" target={"_blank"} > | GitHub Frontend </a>
                <a href={"https://www.github.com/OlgaSadova/FinalProjectBackEnd"} value="yoututorgithubback" target={"_blank"}> | GitHub Backend </a>
              </small>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-7 border-dark port-card">
          <div className="card card border-dark shadow mb-2 bg-white rounded img-thumbnail">
            ...
            <div className="card-body">
              ...
              <small className="text-muted">
                <a href={"https://www.flixlists.herokuapp.com/movies"} value="flixlistsheroku" target={"_blank"}>flixlists Web </a>
                <a href={"https://www.github.com/yotambaram/Flixlists"} value="flixlistsgithub" target={"_blank"}> | GitHub </a>
              </small>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-7 border-dark port-card">
          <div className="card card border-dark shadow mb-2 bg-white rounded img-thumbnail">
            ...
            <div className="card-body">
              ...
              <small className="text-muted">
                <a href={"https://www.yotambaram.github.io/Weather-Dashboard"} value="Weather-Dashboard" target={"_blank"} >Weather Dashboard Web |</a></small><small className="text-muted">
                <a href={"https://www.github.com/yotambaram/Weather-Dashboard"} value="Weather-Dashboard-github" target={"_blank"} > GitHab </a>
              </small>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-7 border-dark port-card">
         <div className="card card border-dark shadow mb-2 bg-white rounded img-thumbnail">
            ...
            <div className="card-body">
              ...
              <small className="text-muted">
                <a href={"https://www.commiewalker.github.io/Findr"} value="finder-github1" target={"_blank"} title="project three"> Findr Web |</a></small><small className="text-muted">
                <a href={"https://www.github.com/commiewalker/Findr"} value="finder-github2" target={"_blank"} title="project three"> GitHab </a>
              </small>
            </div>
          </div>
        </div>
