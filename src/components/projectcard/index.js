          ...
          <div className="card mb-3 card border-dark mb-3 shadow mb-5 bg-white rounded img-thumbnail">
            ...
            <div className="card-body">
              ...
              <a className="card-text"><small className="text-muted">
                <a href="https://yoututor2020.herokuapp.com" value="yoututorheroku" target="_blank title" Find Tutor>Find Tutor app</a>
                <a href="https://github.com/OlgaSadova/FinalProject" value="yoututorgithubfront" target="_blank title" Find Tutor> | Find Tutor GitHub Frontend Repo</a>
                <a href="https://github.com/OlgaSadova/FinalProjectBackEnd" value="yoututorgithubback" target="_blank title" Find Tutor> | Find Tutor GitHub Backend Repo</a></small>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-7 border-dark port-card" id='project-one'>
          <div className="card mb-3 card border-dark shadow mb-3 bg-white rounded img-thumbnail">
            ...
            <div className="card-body">
              ...
              <a className="card-text"><small className="text-muted">
                <a href="https://flixlists.herokuapp.com/movies" value="flixlistsheroku" target="_blank title" project one>flixlists Website </a>
                <a href="https://github.com/yotambaram/Flixlists" value="flixlistsgithub" target="_blank title"> | flixlists GitHub Repo</a></small>
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="row">
        ...
        <div className="col-12 col-md-7 border-dark port-card" id='project-one'>
          <div className="card card border-dark shadow mb-3 bg-white rounded img-thumbnail">
            <a href="https://yotambaram.github.io/Weather-Dashboard" value="Weather-Dashboard-github1" target="_blank" title="project on">
            ...
            <div className="card-body">
              ...
              <a className="card-text"><small className="text-muted">
                <a href="https://yotambaram.github.io/Weather-Dashboard" value="Weather-Dashboard" target="_blank title=">| Weather Dashboard |</a></small><small className="text-muted">
                  <a href="https://github.com/yotambaram/Weather-Dashboard" value="Weather-Dashboard-github" target="_blank title=" > Weather Dashboard GitHab repo |</a></small>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-7 border-dark port-card" id='project-three'>
          <div className="card card border-dark shadow mb-3 bg-white rounded img-thumbnail">
            ...
            <div className="card-body">
              ...
              <a className="card-text"><small className="text-muted">
                <a href="https://commiewalker.github.io/Findr" value="finder-github1" target="_blank" title="project three">| Findr Githab |</a></small><small className="text-muted">
                  <a href="https://github.com/commiewalker/Findr" value="finder-github2" target="_blank" title="project three">| Findr GitHab repo |</a></small>
              </a>
            </div>
          </div>
        </div>
